...
void HMLolStats::Gestisci(const rapidjson::Document& document, DatabaseConfig& dbManager, crow::websocket::connection& conn) {//Vedi HMCsStats.cpp per i commenti funzioni simili ma adattate per giochi differenti suddivise per avere una scalabilità del codice maggiore
